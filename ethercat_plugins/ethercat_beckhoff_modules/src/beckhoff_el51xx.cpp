...
class Beckhoff_EL5151 : public ethercat_interface::EcSlave
{
public:
  Beckhoff_EL5151()
...
private:
  ...
  ec_pdo_info_t pdos_[2] = {
    {0x1600, 7, channels_ + 0},
    {0x1a00, 15, channels_ + 7},
  };
  ec_sync_info_t syncs_[5] = {
    {0, EC_DIR_OUTPUT, 0, NULL, EC_WD_DISABLE},
    {1, EC_DIR_INPUT, 0, NULL, EC_WD_DISABLE},
...
PLUGINLIB_EXPORT_CLASS(ethercat_plugins::Beckhoff_EL5151, ethercat_interface::EcSlave)
