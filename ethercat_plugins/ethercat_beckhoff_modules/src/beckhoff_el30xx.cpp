...
class Beckhoff_EL3004 : public ethercat_interface::EcSlave
{
public:
  Beckhoff_EL3004()
  : EcSlave(0x00000002, 0x0bbc3052) {}
  virtual ~Beckhoff_EL3004() {}
...
PLUGINLIB_EXPORT_CLASS(ethercat_plugins::Beckhoff_EL3004, ethercat_interface::EcSlave)
