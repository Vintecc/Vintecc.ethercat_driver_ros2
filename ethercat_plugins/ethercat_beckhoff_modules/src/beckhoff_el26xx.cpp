...
class Beckhoff_EL2624 : public ethercat_interface::EcSlave
{
public:
  Beckhoff_EL2624()
  : EcSlave(0x00000002, 0x0a403052) {}
  virtual ~Beckhoff_EL2624() {}
...
PLUGINLIB_EXPORT_CLASS(ethercat_plugins::Beckhoff_EL2624, ethercat_interface::EcSlave)
